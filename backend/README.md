...
## Project Structure
    ...
    ├── testapiautosetting_123698  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123698`
...
2. Clone this repo and `cd testapiautosetting_123698`
